...
CGO_ENABLED=0 GOOS=linux GOARCH=amd64 GO111MODULE=on go build -o bin/amd64/cloud-adaptor ./cmd/cloud-adaptor
CGO_ENABLED=0 GOOS=linux GOARCH=arm64 GO111MODULE=on go build -o bin/arm64/cloud-adaptor ./cmd/cloud-adaptor
